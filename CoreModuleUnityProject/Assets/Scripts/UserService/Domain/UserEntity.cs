...
namespace UserData
{
    public class UserEntity
    {
        ...
        public UserEntity UpdateName(UserName name)
        {
            return new UserEntity(UserId, name, CreateAt, LastSigninDateTime);
        }
        
        public UserEntity UpdateLastSigninDateTime(DateTime lastSigninDateTime)
        {
            return new UserEntity(UserId, Name, CreateAt, lastSigninDateTime);
        }
    }
